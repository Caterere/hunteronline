...
1.  Ler [`ART_PIPELINE_CANON.md`](../bibles/ART_PIPELINE_CANON.md).
2.  Ler o SSOT do tema (personagem → Style Bible; mundo → Production Bible).
...
7.  Substituir os placeholders:
    ...
    -   `[ACTION]`
8.  Gerar.
9.  Comparar com os assets aprovados + referências em `assets/reference/`.
10. Testar na escala real do Godot.
11. Só depois registrar em `docs/systems/ASSET_REGISTRY.md`.
