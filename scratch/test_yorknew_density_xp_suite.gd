...
func _test_yorknew_density_gate() -> void:
	...
	_ok(mapa_off.get_node_or_null("Killua") != null, "Killua presente (etapa 16)")
	_ok(mapa_off.get_node_or_null("Silva") != null, "Silva presente (etapa 17)")
	_ok(mapa_off.get_node_or_null("MafiosoMissao_B") != null, "Mafioso missão B (etapa 5)")
	_ok(mapa_off.get_node_or_null("CloneFeitan_B") != null, "Clone Feitan B (etapa 18)")
	...
	_ok(mapa_on.get_node_or_null("GyoCopiaKortopi") != null, "Gyo copia_kortopi (canon)")
	_ok(mapa_on.get_node_or_null("GyoFitaGing") != null, "Gyo fita_ging (canon)")
	_ok(mapa_on.get_node_or_null("ZetsuGalpaoMachiNobunaga") != null, "Zetsu galpão Machi/Nobunaga")
