...
func _pintar_piso_arena() -> void:
	# Pinta a plataforma de duelo (mármore/ouro) com ringue carmesim central,
	# usando o tileset Wang gerado no PixelLab (autotiling por cantos).
	if get_node_or_null("PisoArenaCelestial") != null:
		return
